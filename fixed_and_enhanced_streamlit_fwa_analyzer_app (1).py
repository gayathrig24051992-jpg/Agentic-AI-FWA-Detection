...
st.set_page_config(page_title="SentraGuard", layout="wide", initial_sidebar_state="expanded")

st.title("🏥SentraGuard: Agentic AI-Powered FWA Detection")
st.markdown("""
next-generation platform designed to detect and mitigate Fraud, Waste, and Abuse (FWA) across enterprise systems. Built on AWS Bedrock, it harnesses the power of Agentic AI—autonomous,
goal-driven agents capable of reasoning, planning, and executing complex detection workflows.
""")
