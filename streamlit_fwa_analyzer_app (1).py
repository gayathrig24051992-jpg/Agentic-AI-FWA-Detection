# -*- coding: utf-8 -*-
"""Streamlit FWA Analyzer App

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1msPxcT0EoTOy-hoOwxLGhAl_dnERyt3I
"""
...
# --- Streamlit UI ---
st.set_page_config(page_title="FWA Medical Claim Analyzer", layout="centered")

st.title("🏥 Fraud, Waste, and Abuse (FWA) Medical Claim Analyzer")
...
with st.expander("Advanced Configuration (Optional)"):
    agent_id_input = st.text_input("Bedrock Agent ID", value=DEFAULT_AGENT_ID)
    agent_alias_id_input = st.text_input("Bedrock Agent Alias ID", value=DEFAULT_AGENT_ALIAS_ID)
    aws_region_input = st.text_input("AWS Region", value=DEFAULT_AWS_REGION)
